...
public class Pathfinding : MonoBehaviour
{
    ...
    Queue<Tile> FloodFill(Tile start, Tile goal) // Also known as breadth-first search
    {
    ...
    /// <summary>
    /// Determines the Manhattan Distance between two tiles. (=How many Tiles the player must move to reach it)
    /// </summary>
